        ...
        <div className="hidden items-center gap-8 lg:flex">
          <a href={`tel:${site.phone}`} className="flex items-center gap-3 transition-opacity hover:opacity-80">
            ...
            <span className="flex flex-col leading-tight">
              <span className="text-lg font-bold text-foreground">{site.phoneDisplay}</span>
              <span className="text-xs text-muted-foreground">{t.header.phoneLabel}</span>
            </span>
          </a>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="flex flex-col leading-tight">
              <span className="text-lg font-bold text-foreground">{t.header.hoursTitle}</span>
              <span className="text-xs text-muted-foreground">{t.header.hoursValue}</span>
            </span>
          </div>
        </div>
